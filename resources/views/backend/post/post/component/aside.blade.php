...
<div class="ibox w">
    <div class="ibox-title">
        <h5>Dành riêng cho phần CỔ ĐÔNG</h5>
    </div>
    <div class="ibox-content">
        <div class="row mb15">
            <div class="col-lg-12 mb10">
            ...
            <div class="col-lg-12 mb10">
                <div class="form-row">
                    <input 
                        type="date"
                        name="released_at"
                        value="{{ old('released_at', isset($post->released_at) ? \Carbon\Carbon::parse($post->released_at)->format('Y-m-d') : '') }}"
